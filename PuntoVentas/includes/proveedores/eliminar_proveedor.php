    ...
    <head>
        ...
        <script language="javascript">
            ...
            function aceptar(codproveedor) {
                location.href = "guardar_proveedor.php?codproveedor=" + codproveedor + "&accion=baja";
            }
                    ...
                    <div id="frmBusqueda">
                        <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                            ...
                            if ($codprovincia <> 0) {
                                ...
                                $res_provincias = $conn->consulta($query_provincias);
                            ...
                            if ($codentidad <> 0) {
                                ...
                                $res_entidades = $conn->consulta($query_entidades);
