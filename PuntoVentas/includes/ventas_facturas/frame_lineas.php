<script>
    function eliminar_linea(codfacturatmp, numlinea, importe)
    {
        ...
        parent.document.getElementById("contadorFilas").setAttribute('value', parent.document.getElementById("contadorFilas").value - 1);
    }
</script>
    ...
    <table class="fuente8" width="100%" cellspacing=1 cellpadding=3 border=0 ID="Table1">
        ...
        for ($i = 0; $i < @@$conn->num_rows($rs_lineas); $i++) {
            ...
            <tr class="<?php echo $fondolinea ?>">
                ...
                <td width="18%"><div align="center"><?php echo $nombrefamilia ?></div></td>
                <td width="14%"><div align="center"><?php echo $referencia ?></div></td>
                <td width="25%"><div align="center"><?php echo $descripcion ?></div></td>
...
<div id="ztotales" align="center">
    ...
    <table width="30%" border=0 align="right" cellpadding=3 cellspacing=0 class="fuente8">
        <tr>
