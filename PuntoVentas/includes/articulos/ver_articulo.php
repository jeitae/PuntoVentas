                    ...
                    <div id="frmBusqueda">
                        <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><?php echo@$GLOBALS['simbolomoneda'] . " " .  mysql_result($rs_query, 0, "precio_compra")  ?></td>
                            </tr>
                            <tr>
                                <td>Precio almac&eacute;n</td>
                                <td colspan="2"><?php echo @$GLOBALS['simbolomoneda'] . " " . mysql_result($rs_query, 0, "precio_almacen")  ?></td>
                            </tr>												
                            <tr>
                                <td>Precio en tienda</td>
                                <td colspan="2"><?php echo @$GLOBALS['simbolomoneda'] . " " . mysql_result($rs_query, 0, "precio_tienda")  ?></td>
                            </tr>
                            <!--<tr>
                                    <td>Pvp</td>
                            ...
                            <tr>
                                <td>Precio con IV</td>
                                <td colspan="2"><?php echo @$GLOBALS['simbolomoneda'] . " " . mysql_result($rs_query, 0, "precio_iva") ?> </td>
                            </tr>
                            <tr>
