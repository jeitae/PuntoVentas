                            ...
                            <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><select id="cboFamilias" name="AcboFamilias" class="comboGrande">
                                            ...
                                            <?php
                                            while ($contador < @$conn->num_rows($res_familias)) {
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><select id="cboImpuestos" name="AcboImpuestos" class="comboMedio">
                                            ...
                                            <?php
                                            while ($contador < @$conn->num_rows($res_impuesto)) {
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><?php echo @$GLOBALS['simbolomoneda'] ?><input NAME="qprecio_compra" type="text" class="cajaPequena" id="precio_compra" size="10" maxlength="10" value="<?php echo mysql_result($rs_query, 0, "precio_compra") ?>">
                                       
                                </tr>
                                <tr>
                                    <td>Precio de almac&eacute;n</td>
                                    <td colspan="2"><?php echo @$GLOBALS['simbolomoneda'] ?><input NAME="qprecio_almacen" type="text" class="cajaPequena" id="precio_almacen" size="10" maxlength="10" value="<?php echo mysql_result($rs_query, 0, "precio_almacen") ?>">
                                      
                                </tr>
                                <tr>
                                    <td>Precio de tienda</td>
                                    <td colspan="2"><?php echo @$GLOBALS['simbolomoneda'] ?><input NAME="qprecio_tienda" type="text" class="cajaPequena" id="precio_tienda" size="10" maxlength="10" value="<?php echo mysql_result($rs_query, 0, "precio_tienda") ?>">
                                ...
                                <tr>
                                    <td>Precio con IV</td>
                                    <td colspan="2"><?php echo @$GLOBALS['simbolomoneda'] ?><input NAME="qprecio_iva" type="text" class="cajaPequena" id="precio_iva" size="10" maxlength="10" value="<?php echo mysql_result($rs_query, 0, "precio_iva") ?>">
