...
<table width="50%" border="0">
  ...
  <tr>
    <td><span class="Estilo3">DE FACTURA No.: <?php  echo $minimo?> A FACTURA No.: <?php  echo $maximo?></span></td>
  </tr>
  <tr>
    <td><span class="Estilo3">NETO: <?php  echo @number_format($neto,2,".",",")?> + <?php  echo $ivaimp ?> % IV: <?php  echo @number_format($iva,2,".",",")?></span></td>
  </tr>
  <tr>
