...
$rs_alb = $conn->consulta($sel_alb);
$nombreCliente = mysql_result($rs_alb, 0, "nombreCliente");
...
$fechahoy = date("Y-m-d");
$sel_albaran = "call pConsulta_codFactura()";
$rs_albaran = $conn->consulta($sel_albaran);
$resultadoFact = $conn->fetch_array($rs_albaran);
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function ventanaArticulos() {
                miPopup = window.open("ver_articulos.php", "miwin2", "width=700,height=500,scrollbars=yes");
                miPopup.focus();
            }
                        ...
                        <form id="formulario" name="formulario" method="post" action="guardar_factura.php">
                            <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                                <tr>
                                    ...
                                    <td width="27%"><input NAME="nombre" type="text" class="cajaGrande" id="nombre" size="45" maxlength="45" value="<?php echo $nombreCliente; ?>" readonly></td>
                                ...
                                <tr>
                                    ...
                                    <td width="64%"><input NAME="iva" type="text" class="cajaPequena" id="iva" size="5" maxlength="5" onChange="cambio_iva()" value="<?php echo $iva ?>">%
                                        <div style="margin:0 10px 6px 0; float:right;">N&deg; de Factura <input name="numfactura" id="numfactura" type="text" value="<?php echo $numfactura ?>"></div>
                                    </td>
                                </tr>
                                <tr>
