    ...
    <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
        ...
        for ($i = 0; $i < mysql_num_rows($rs_lineas); $i++) {
            ...
            <tr class="<?php echo $fondolinea ?>">
                <td width="10%"><div align="center"><?php echo $i + 1 ?></div></td>
                <td width="16%"><div align="center"><?php echo $referencia ?></div></td>
                <td width="45%"><div align="center"><?php echo $descripcion ?></div></td>
                ...
                <td width="6%"><a href="javascript:eliminar_linea(<?php echo $codfacturatmp ?>,<?php echo $numlinea ?>,<?php echo $importe ?>)"><img src="../img/eliminar.png" border="0"></a></td>
            </tr>
            <?php
        }
