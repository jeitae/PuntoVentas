            ...
            <div id="zonaContenido">
                <div align="center">
                    ...
                    <div id="botonBusqueda">
                        <img src="../img/botonaceptar.jpg" width="85" height="22" onClick="validar(formulario, true)" border="1" style="cursor:pointer;">
                        <img src="../img/botonlimpiar.jpg" width="69" height="22" onClick="limpiar()" border="1" style="cursor:pointer;">
